...
import com.hartwig.serve.common.fusion.FusionCommon;
...
public class GeneData
{
    ...
    public boolean forwardStrand() { return Strand == FusionCommon.POS_STRAND; }
    public boolean reverseStrand() { return Strand == FusionCommon.NEG_STRAND; }
