...
public class RefGenomeManager {
    ...
    private ExtractionResult convert(@NotNull ExtractionResult extraction, @NotNull RefGenome targetVersion) {
        ...
        return ImmutableExtractionResult.builder()
                ...
                .actionableCodons(converter.convertActionableCodons(filteredExtraction.actionableCodons()))
                .actionableExons(converter.convertActionableExons(filteredExtraction.actionableExons()))
