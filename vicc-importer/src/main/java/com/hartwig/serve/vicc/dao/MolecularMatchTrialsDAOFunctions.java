...
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALS;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSALTERATION;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSARMGROUPLABEL;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSCONTACT;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSCOORDINATES;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSGEO;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSINTERVENTION;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSLOCATION;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSOTHERNAME;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSOVERALLCONTACT;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSSUBLOCATION;
import static com.hartwig.serve.vicc.database.Tables.MOLECULARMATCHTRIALSTAG;
        ...
        for (MolecularMatchTrialsLocation location : molecularMatchTrials.locations()) {
            ...
            if (geo != null) {
                context.insertInto(MOLECULARMATCHTRIALSGEO,
                        ...
                        MOLECULARMATCHTRIALSGEO.MOLECULARMATCHTRIALSLOCATIONID).values(geo.lat(), geo.lon(), idLocation).execute();
            }
        }
