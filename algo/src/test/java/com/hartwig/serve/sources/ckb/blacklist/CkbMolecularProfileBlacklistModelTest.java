...
public class CkbMolecularProfileBlacklistModelTest {

    @Test
    public void canFilterOnKeywords() {
        CkbMolecularProfileBlacklistModel blacklistEventWithKey = new CkbMolecularProfileBlacklistModel(createFilterEntryList(
                CkbBlacklistMolecularProfileType.FILTER_EVENT_WITH_KEYWORD,
                "benign"));
    ...
    public void canFilterOnGenes() {
        CkbMolecularProfileBlacklistModel blacklistEvidenceOnGene = new CkbMolecularProfileBlacklistModel(createFilterEntryList(
                CkbBlacklistMolecularProfileType.FILTER_ALL_EVIDENCE_ON_GENE,
                "gene"));
        ...
        CkbMolecularProfileBlacklistModel blacklistEvidenceForExonsOnGene = new CkbMolecularProfileBlacklistModel(createFilterEntryList(
                CkbBlacklistMolecularProfileType.FILTER_EVIDENCE_FOR_EXONS_ON_GENE,
                "gene"));
    ...
    public void canRemoveUnresolvableFusionLegs() {
        CkbMolecularProfileBlacklistModel blacklistSecondarygeneWhenFusionLeg = new CkbMolecularProfileBlacklistModel(createFilterEntryList(
                CkbBlacklistMolecularProfileType.FILTER_SECONDARY_GENE_WHEN_FUSION_LEG,
                "FILT"));
    ...
    public void canRemoveExclusiveFusionGenes() {
        CkbMolecularProfileBlacklistModel blacklistGeneInFusionExclusively = new CkbMolecularProfileBlacklistModel(createFilterEntryList(
                CkbBlacklistMolecularProfileType.ALLOW_GENE_IN_FUSIONS_EXCLUSIVELY,
                "gene"));
    ...
    public void canFilterOnFullNames() {
        CkbMolecularProfileBlacklistModel blacklistVariantFullname = new CkbMolecularProfileBlacklistModel(createFilterEntryList(
                CkbBlacklistMolecularProfileType.FILTER_EXACT_VARIANT_FULLNAME,
                "BRAF V600E"));
    ...
    @NotNull
    private static List<CkbBlacklistMolecularProfileEntry> createFilterEntryList(@NotNull CkbBlacklistMolecularProfileType type,
