...
public class KnowledgebaseTest {
    ...
    public void canConvertBackAndForth() {
        Set<Knowledgebase> sources = Set.of(Knowledgebase.VICC_CGI, Knowledgebase.VICC_CIVIC);
    ...
    public void canConvertSourcesToString() {
        ...
        Set<Knowledgebase> sources2 = Set.of(Knowledgebase.VICC_CIVIC, Knowledgebase.VICC_CGI);
