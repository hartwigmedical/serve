...
public final class ServeAlgoTestFactory {
    ...
    public static ExtractionResult createResultForSource(@NotNull Knowledgebase source) {
        return ImmutableExtractionResult.builder()
                ...
                .addActionableCodons(RangeTestFactory.createTestActionableCodonForSource(source))
                .addActionableExons(RangeTestFactory.createTestActionableExonForSource(source))
