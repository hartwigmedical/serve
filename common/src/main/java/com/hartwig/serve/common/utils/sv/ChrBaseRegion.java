...
public class ChrBaseRegion implements Cloneable, Comparable<ChrBaseRegion>
{
    ...
    public int start() { return Positions[StartEndIterator.SE_START]; }
    public int end() { return Positions[StartEndIterator.SE_END]; }
    public String chromosome() { return Chromosome; }

    public void setPosition(int position, int index) { Positions[index] = position; }
    public void setStart(int pos) { setPosition(pos, StartEndIterator.SE_START); }
    public void setEnd(int pos) { setPosition(pos, StartEndIterator.SE_END); }

    public int baseLength() { return length() + 1; }
    public int length() { return Positions[StartEndIterator.SE_END] - Positions[StartEndIterator.SE_START]; }

    public boolean isValid() { return HumanChromosome.contains(Chromosome) && hasValidPositions(); }
    public boolean hasValidPositions() { return Positions[StartEndIterator.SE_START] > 0 & Positions[StartEndIterator.SE_END] >= Positions[StartEndIterator.SE_START]; }
    ...
    public boolean overlaps(final ChrBaseRegion other)
    {
        ...
        return BaseRegion.positionsOverlap(Positions[StartEndIterator.SE_START], Positions[StartEndIterator.SE_END], other.Positions[StartEndIterator.SE_START], other.Positions[StartEndIterator.SE_END]);
    }
    ...
    public String toString() { return String.format("%s:%d-%d", Chromosome, Positions[StartEndIterator.SE_START], Positions[StartEndIterator.SE_END]); }
