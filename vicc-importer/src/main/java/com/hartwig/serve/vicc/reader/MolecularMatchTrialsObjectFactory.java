...
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrials;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsContact;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsGeo;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsIntervention;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsLocation;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsOverallContact;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsSubLocation;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.ImmutableMolecularMatchTrialsTag;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrials;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsContact;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsGeo;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsIntervention;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsLocation;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsOverallContact;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsSubLocation;
import com.hartwig.serve.vicc.datamodel.molecularmatchtrials.MolecularMatchTrialsTag;
...
final class MolecularMatchTrialsObjectFactory {
    ...
    static MolecularMatchTrials create(@NotNull JsonObject molecularMatchTrialsObject) {
        ...
        return ImmutableMolecularMatchTrials.builder()
                ...
                .startDate(optionalOrNullableString(molecularMatchTrialsObject, "startDate"))
                ...
                .overallContact(createOverallContact(optionalOrNullableObject(molecularMatchTrialsObject, "overallContact")))
    ...
    private static List<MolecularMatchTrialsLocation> createLocations(@NotNull JsonArray locationArray) {
        ...
        for (JsonElement locationElement : locationArray) {
            ...
            locationList.add(ImmutableMolecularMatchTrialsLocation.builder()
                    ...
                    .contact(createContact(optionalOrNullableObject(locationObject, "contact")))
                    ...
                    .subLocation(createSubLocation(optionalOrNullableObject(locationObject, "location")))
                    ...
                    .geo(createGeo(optionalOrNullableObject(locationObject, "geo")))
                    .build());
        }
    ...
    private static MolecularMatchTrialsOverallContact createOverallContact(@Nullable JsonObject overallContactObject) {
        ...
        return ImmutableMolecularMatchTrialsOverallContact.builder()
                ...
                .affiliation(optionalOrNullableString(overallContactObject, "affiliation"))
                .lastName(optionalString(overallContactObject, "last_name"))
                .email(optionalString(overallContactObject, "email"))
                .phone(optionalOrNullableString(overallContactObject, "phone"))
