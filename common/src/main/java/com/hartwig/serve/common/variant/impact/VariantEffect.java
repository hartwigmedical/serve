...
public enum VariantEffect {
    ...
    public boolean isEffectOf(@NotNull final String name) {
        return name.equals(mEffect);
    }
    ...
    public static boolean isInframe(final VariantEffect effect) {
        return effect == INFRAME_DELETION || effect == INFRAME_INSERTION || effect == PHASED_INFRAME_DELETION
                || effect == PHASED_INFRAME_INSERTION;
    }
